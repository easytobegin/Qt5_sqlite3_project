#############################################################################
# Makefile for building: qrcodedecoder-pc4
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  qrcodedecoder-pc4.pro
# Template: app
# Command: /usr/lib/i386-linux-gnu/qt5/bin/qmake -spec linux-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile qrcodedecoder-pc4.pro
#############################################################################
...
INCPATH       = -I/usr/lib/i386-linux-gnu/qt5/mkspecs/linux-g++ -I. -I. -I/usr/local/include -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I. -I.
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS) -L/usr/local/lib -lsqlite3 -lQt5Widgets -L/usr/lib/i386-linux-gnu -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = main.cpp \
		EditRecord.cpp \
		managementform.cpp qrc_background.cpp \
		moc_EditRecord.cpp \
		moc_managementform.cpp
OBJECTS       = main.o \
		EditRecord.o \
		managementform.o \
		qrc_background.o \
		moc_EditRecord.o \
		moc_managementform.o
DIST          = /usr/lib/i386-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		qrcodedecoder-pc4.pro \
		background.qrc \
		qrcodedecoder-pc4.pro
QMAKE_TARGET  = qrcodedecoder-pc4
...
$(TARGET): ui_management.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)
	{ test -n "$(DESTDIR)" && DESTDIR="$(DESTDIR)" || DESTDIR=.; } && test $$(gdb --version | sed -e 's,[^0-9][^0-9]*\([0-9]\)\.\([0-9]\).*,\1\2,;q') -gt 72 && gdb --nx --batch --quiet -ex 'set confirm off' -ex "save gdb-index $$DESTDIR" -ex quit '$(TARGET)' && test -f $(TARGET).gdb-index && objcopy --add-section '.gdb_index=$(TARGET).gdb-index' --set-section-flags '.gdb_index=readonly' '$(TARGET)' '$(TARGET)' && rm -f $(TARGET).gdb-index || true

Makefile: qrcodedecoder-pc4.pro /usr/lib/i386-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/i386-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile qrcodedecoder-pc4.pro
...
dist: 
	@test -d .tmp/qrcodedecoder-pc41.0.0 || mkdir -p .tmp/qrcodedecoder-pc41.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/qrcodedecoder-pc41.0.0/ && $(COPY_FILE) --parents background.qrc .tmp/qrcodedecoder-pc41.0.0/ && $(COPY_FILE) --parents EditRecord.h managementform.h .tmp/qrcodedecoder-pc41.0.0/ && $(COPY_FILE) --parents main.cpp EditRecord.cpp managementform.cpp .tmp/qrcodedecoder-pc41.0.0/ && $(COPY_FILE) --parents management.ui .tmp/qrcodedecoder-pc41.0.0/ && (cd `dirname .tmp/qrcodedecoder-pc41.0.0` && $(TAR) qrcodedecoder-pc41.0.0.tar qrcodedecoder-pc41.0.0 && $(COMPRESS) qrcodedecoder-pc41.0.0.tar) && $(MOVE) `dirname .tmp/qrcodedecoder-pc41.0.0`/qrcodedecoder-pc41.0.0.tar.gz . && $(DEL_FILE) -r .tmp/qrcodedecoder-pc41.0.0
...
compiler_rcc_make_all: qrc_background.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_background.cpp
qrc_background.cpp: background.qrc \
		259453-14061G2132487.jpg
	/usr/lib/i386-linux-gnu/qt5/bin/rcc -name background background.qrc -o qrc_background.cpp

compiler_moc_header_make_all: moc_EditRecord.cpp moc_managementform.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_EditRecord.cpp moc_managementform.cpp
moc_EditRecord.cpp: /usr/include/qt5/QtGui/QtGui \
...
moc_managementform.cpp: /usr/include/qt5/QtWidgets/QDialog \
		...
		managementform.h
	/usr/lib/i386-linux-gnu/qt5/bin/moc $(DEFINES) $(INCPATH) -I/usr/include/c++/4.8 -I/usr/include/i386-linux-gnu/c++/4.8 -I/usr/include/c++/4.8/backward -I/usr/lib/gcc/i686-linux-gnu/4.8/include -I/usr/local/include -I/usr/lib/gcc/i686-linux-gnu/4.8/include-fixed -I/usr/include/i386-linux-gnu -I/usr/include managementform.h -o moc_managementform.cpp

compiler_moc_source_make_all:
compiler_moc_source_clean:
compiler_uic_make_all: ui_management.h
compiler_uic_clean:
	-$(DEL_FILE) ui_management.h
ui_management.h: management.ui
	/usr/lib/i386-linux-gnu/qt5/bin/uic management.ui -o ui_management.h
...
EditRecord.o: EditRecord.cpp EditRecord.h \
		...
		/usr/include/qt5/QtWidgets/qlayoutitem.h \
		/usr/include/qt5/QtWidgets/qboxlayout.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o EditRecord.o EditRecord.cpp

managementform.o: managementform.cpp /usr/include/qt5/QtGui/QtGui \
		/usr/include/qt5/QtGui/QtGuiDepends \
		/usr/include/qt5/QtCore/QtCore \
		/usr/include/qt5/QtCore/QtCoreDepends \
		/usr/include/qt5/QtCore/qabstractanimation.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o managementform.o managementform.cpp

qrc_background.o: qrc_background.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qrc_background.o qrc_background.cpp

moc_EditRecord.o: moc_EditRecord.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_EditRecord.o moc_EditRecord.cpp

moc_managementform.o: moc_managementform.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_managementform.o moc_managementform.cpp
